...
class MT5Connection(Base):
    ...
    variant_id = Column(String, ForeignKey("variants.id"), nullable=False, unique=True)
    ...
    status = Column(String, default="pending")         # pending | deploying | connected | error | disconnected
